...
## Current status
- Phase 1 (networking skeleton) — ✅ complete, verified 2026-07-02
  (Windows + Mac clients over Steam relay).
- Phase 2 (proximity voice) — ✅ complete, verified 2026-07-02
  (distance falloff + panning, voice modes, mute, speaking indicators).
